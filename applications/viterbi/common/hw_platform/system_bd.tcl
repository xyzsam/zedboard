...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_DATA_DEPTH {8192} CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI3}  ] $ila_1
  ...
  # Create instance: viterbi_baseline_0, and set properties
  set viterbi_baseline_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:viterbi_baseline:1.0 viterbi_baseline_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins viterbi_baseline_0/INPUT_STREAM]
connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ila_0/SLOT_0_AXIS] [get_bd_intf_pins viterbi_baseline_0/INPUT_STREAM]
...
connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins ila_2/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins viterbi_baseline_0/s_axi_BUS_A]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs viterbi_baseline_0/s_axi_BUS_A/Reg] SEG_viterbi_baseline_0_Reg
